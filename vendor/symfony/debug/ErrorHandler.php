...
class ErrorHandler
{
     ...
     * @param array|int       $levels  An array map_files of E_* to LogLevel::* or an integer bit field of E_* constants
     ...
     *
     * @param array $loggers Error levels to [LoggerInterface|null, LogLevel::*] map_files
     *
     * @return array The previous map_files
     *
